<template>
  <div class="all-contacts">
    <div class="book-header">
      ...
      <p class="contactLength">You have: {{ contacts.length }} {{ ifContacts }}</p> 
    </div>
    <transition name="fade">
      <div class="add-contact-container" v-if="show">
        ...
        <table>
          ...
          <tr>
            <td> 
              <input id="contactName" type="text" placeholder="Enter contact name" required />
              <p class="errorMsg">{{ this.errors[0] }}</p>
            </td>
            <td>
              <input id="contactCountry" type="text" placeholder="Enter contact country" required />
              <p class="errorMsg">{{ this.errors[1] }}</p>
            </td>
            <td>
              <input id="contactCity" type="text" placeholder="Enter contact city" required />
              <p class="errorMsg">{{ this.errors[2] }}</p>
            </td>
            <td>
              <input id="contactPhone" type="text" placeholder="Enter contact phone number" required />
